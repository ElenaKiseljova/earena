<?php
/*
Template Name: Статистика пользователей (админ)
*/
  ...
  <div class="page-main__wrapper page-main__wrapper--statistic" id="app_create_tournament">
      ...
      <div id="top-for-scroll">
          <div class="page-main__header page-main__header--statistic">
            <h2 v-if="!load" style="flex: 1" class="filter-heading-title"><?php _e('Игроки ', 'earena'); ?> <?= $users ?></h2>
            <div class="tabs tabs--statistic">
              ...
              <a href="<?php echo get_page_link(6307); ?>" :class="{'active':activeTab===2}" class="tabs__button tabs__button--statistic">
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-12">
                          <div class="select-box"
                              ...
                              <button :aria-expanded="ddflag[0]"
                                  ...
                                  {{types[formData.type]}} {{total}}<span class="arrow"></span>
                              </button>
                      ...
                      <div class="col-lg-2 col-md-4 col-sm-6 col-xs-12"><?php _e('На счету', 'earena'); ?>
                          <div>
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="padding: 10px 5px">
                                  <input
                                      @change="changeForm" @input="changeForm" v-model="formData.balance.from"
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 justify-content-between" style="display:flex;">
                          <div class="checkboxes d-flex">
                              <label class="box_ckeck check_tour" style="margin: 15px 20px 0 0  ">
                                  <input @change="changeForm" type="checkbox" class="game1" name="vip"
                                         required="required"
                              ...
                              <label class="box_ckeck check_tour" style="margin: 15px 20px 0 0  ">
                                  <input @change="changeForm" type="checkbox" class="game1" name="verification"
                                         required="required"
                                         v-model="formData.verification">
                                  <span class="checkmark"></span>
                                  <?php _e('Верифицирован', 'earena'); ?>
                              </label>
                              <label class="box_ckeck check_tour" style="margin: 15px 20px 0 0  ">
                                  <input @change="changeForm" type="checkbox" class="game1" name="blocked"
                                         required="required"
                                         v-model="formData.blocked">
                                  <span class="checkmark"></span>
                                  <?php _e('Забанен', 'earena'); ?>
                              </label>

                              <!-- <label class="box_ckeck check_tour" style="margin: 15px 20px 0 0  ">
                                  <input @change="changeForm" type="checkbox" class="game1" name="yellow_card_1"
                                         required="required"
                                         v-model="formData.yellow_card_1">
                                  <span class="checkmark"></span>
                                  <?php // _e('1 жалоба', 'earena'); ?>
                              </label> -->
                              <!-- <label class="box_ckeck check_tour" style="margin: 15px 20px 0 0  ">
                                  <input @change="changeForm" type="checkbox" class="game1" name="yellow_card_2"
                                         required="required"
                                         v-model="formData.yellow_card_2">
                                  <span class="checkmark"></span>
                                  <?php // _e('2 жалобы', 'earena'); ?>
                              </label> -->
                          </div>
                          <div @click="reset" class="reset" style="margin-top: 15px; font-weight: bold;">
          ...
          <div class="table-responsive">
              <table class="table table--statistic table-rezult">
                  ...
                  <tr v-key="item.ID" v-for="(item, index) in users">
                      ...
                      <td>
                          <div class="icons">
                              <span class="yellow_cards" v-if="item.yellow_cards > 0">{{item.yellow_cards}}</span><span
                                      class="block" v-if="item.blocked"></span><span class="vip"
                                                                                     v-if="item.vip"></span><span
                                      class="verified" v-if="item.verified"></span><span class="test"
                                                                                         v-if="item.testuser"></span>
                          </div>
                      </td>
                      <td style="text-align: start"><a :href="'<?= home_url('/') ?>user/'+item.ID">{{item.nickname}}</a>
                          ❲<a target="_blank" :href="'<?= home_url('/') ?>?get_transactions='+item.ID">$</a>❳
                      </td>
                      <td>{{item.balance}}</td>
...
<script>
    const app_create_tournament = new Vue({
        ...
        data: {
            ...
            types: [
                '<?php _e('Все', 'earena'); ?>',
                '<?php _e('Тестеровщики', 'earena'); ?>',
                '<?php _e('Игроки', 'earena'); ?>',
            ],
        },
        methods: {
            reset() {
            ...
            ajaxSend() {
                ...
                form_data.append('action', 'getStatistic')
