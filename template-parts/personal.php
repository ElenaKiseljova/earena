...
<div class="personal">
  <ul class="personal__list">
    <li class="personal__item">
      <a class="personal__link <?php if (! $_GET && function_exists('earena_2_current_page')) earena_2_current_page('account'); ?>" href="<?php echo bloginfo( 'url' ); ?>/profile">
    ...
    <li class="personal__item">
      <a class="personal__link <?php if (! is_front_page() && function_exists('earena_2_current_page')) earena_2_current_page('matches'); ?>" href="<?php echo bloginfo( 'url' ); ?>/profile?matches">
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="personal__item">
      <a class="personal__link <?php if (! is_front_page() && function_exists('earena_2_current_page')) earena_2_current_page('tournaments'); ?>" href="<?php echo bloginfo( 'url' ); ?>/profile?tournaments">
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="personal__item">
      <a class="personal__link <?php if (function_exists('earena_2_current_page')) earena_2_current_page('messages'); ?>" href="<?php echo bloginfo( 'url' ); ?>/profile?messages">
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="personal__item">
      <a class="personal__link <?php if (function_exists('earena_2_current_page')) earena_2_current_page('friends'); ?>" href="<?php echo bloginfo( 'url' ); ?>/profile?friends">
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="personal__item">
      <a class="personal__link <?php if (function_exists('earena_2_current_page')) earena_2_current_page('requests'); ?>" href="<?php echo bloginfo( 'url' ); ?>/profile?requests">
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
